...
srun python src/train_deepcfr.py --mode mlp --mlp_hidden 8,16 --traversals_per_seat 5 --lr_regret 0.0005 --lr_policy 0.0005 --iters 1 --device cuda --regret_mem 1000 --policy_mem 1000
