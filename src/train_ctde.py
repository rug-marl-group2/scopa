...
def main():
    ...
    parser.add_argument("--epochs", type=int, default=1000, help="Training epochs (outer loops)")
    parser.add_argument("--episodes_per_epoch", type=int, default=32, help="Episodes sampled per epoch")
    ...
    parser.add_argument("--actor_hidden", type=str, default="512,256,128", help="Comma-separated hidden sizes for actor MLP")
    parser.add_argument("--critic_hidden", type=str, default="512,256,128", help="Comma-separated hidden sizes for critic MLP")
    ...
    parser.add_argument("--eval_episodes", type=int, default=64, help="Episodes per evaluation run")
